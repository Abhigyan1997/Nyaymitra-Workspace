...
import { Mail, Phone, Briefcase, Clock, Star, ChevronRight } from 'lucide-react'
...
export function NyayMitraProfessionalCard({ professional }: { professional: Professional }) {
  const typeColors = {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-start justify-between mb-4">
        <div className="flex items-start gap-3 flex-1 min-w-0">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-muted-foreground mt-0.5">NyayMitra Network</p>
          </div>
        </div>
        <motion.div
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        className="w-full py-2 px-4 bg-primary text-primary-foreground rounded-lg font-medium text-sm hover:bg-primary/90 transition-colors mb-3"
      >
