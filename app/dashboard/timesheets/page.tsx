  ...
  return (
    <div className="p-6 space-y-6">
      ...
      >
        ...
        <p className="text-muted-foreground">Track and manage attorney billable hours.</p>
      </motion.div>
      ...
      >
        ...
        <h2 className="text-2xl font-semibold text-foreground mb-2">Timesheet Management</h2>
        <p className="text-muted-foreground mb-6 max-w-md mx-auto">
          Coming soon - Track billable hours, manage time entries, and generate reports.
        </p>
        <motion.button
